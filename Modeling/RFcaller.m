...
threshold=-70;
[modfreqs10, power10]=RFpoweranalysis('10MHz/0', threshold, 'true');
[modfreqs20, power20]=RFpoweranalysis('20MHz/0', threshold, 'true');
[modfreqs30, power30]=RFpoweranalysis('30MHz/0', threshold, 'true');
[modfreqs40, power40]=RFpoweranalysis('40MHz/0', threshold, 'true');
