...
% together (comb1, (comb1+comb2)/2, comb2).
...
%Old normalization scheme, only performed division if probe was above
...
%Normalization, shift probe so that min value is 0 and add constant small 
%offset to avoid 0/0 errors
